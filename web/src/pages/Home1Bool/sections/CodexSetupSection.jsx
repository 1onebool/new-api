...
<section id="codex-setup" class="py-24 bg-[color:var(--semi-color-bg-1)]">
        <div class="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-r from-cyan-50 to-blue-50 rounded-2xl p-8 mb-12 text-center">
                <h3 class="text-2xl font-bold text-[var(--text-primary)] mb-4">CodeX 快速开始</h3>
                <p class="text-[var(--accent-blue-hover)] text-lg">企业级 AI 编程助手，GPT-5 驱动</p>
            ...
            <div class="flex justify-center mb-12 sm:mb-16">
                <div class="bg-[color:var(--semi-color-bg-1)] rounded-xl p-2 sm:p-3 shadow-lg border border-[color:var(--card-border)] w-full max-w-md sm:max-w-none">
                    <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                        <button onclick="showCodeXSetupPlatform('windows')" id="codex-setup-btn-windows" class="px-4 sm:px-8 py-3 sm:py-4 rounded-lg font-medium transition-colors text-sm sm:text-base text-[var(--text-secondary)] hover:bg-[color:var(--cool-bg-alt)]">Windows</button>
                        <button onclick="showCodeXSetupPlatform('mac')" id="codex-setup-btn-mac" class="px-4 sm:px-8 py-3 sm:py-4 rounded-lg font-medium transition-colors text-sm sm:text-base text-[var(--text-secondary)] hover:bg-[color:var(--cool-bg-alt)]">macOS</button>
...
npm --version</code></pre>
                        ...
                        <div class="bg-[var(--cool-bg)] border-l-4 border-purple-400 p-4 rounded-r-lg mt-4">
                    ...
                    <div class="bg-[color:var(--cool-bg-alt)] rounded-lg p-6">
                        ...
                        <div class="mb-6">
                            ...
                            <ul class="text-[var(--text-secondary)] space-y-2 mb-4 ml-4">
                                <li>• 访问 <a href="https://${apiHost}" target="_blank" class="text-[var(--accent-blue)] hover:underline">${apiName} 控制台</a></li>
                                <li>• 注册账户或登录现有账户</li>
                                <li>• 进入 "API 密钥" 页面</li>
...
cd %USERPROFILE%\.codex</code></pre>
                        ...
                        <div class="mb-6">
                            ...
                            <p class="text-[var(--text-secondary)] mb-3"><strong>1. 创建 config.toml 文件：</strong></p>
                            <p class="text-[var(--text-secondary)] text-sm mb-3">使用记事本或您喜欢的文本编辑器创建 config.toml 文件：</p>
                            <div class="bg-gray-900 rounded-lg overflow-hidden code-block mb-4">
                                <div class="flex items-center justify-between p-3 bg-gray-800">
...
requires_openai_auth = true</code></pre>
                            ...
                            <p class="text-[var(--text-secondary)] mb-3 mt-4"><strong>2. 创建 auth.json 文件：</strong></p>
                            <p class="text-[var(--text-secondary)] text-sm mb-3">在同一目录下创建 auth.json 文件：</p>
                            <div class="bg-gray-900 rounded-lg overflow-hidden code-block">
                                <div class="flex items-center justify-between p-3 bg-gray-800">
...
npm --version</code></pre>
                        ...
                        <p class="text-[var(--text-secondary)] mb-4"><strong>方法二：官网下载</strong></p>
                        <ul class="text-[var(--text-secondary)] space-y-2 mb-4 ml-4">
                            <li>访问 <a href="https://nodejs.org" target="_blank" class="text-[var(--accent-blue)] hover:underline">https://nodejs.org</a></li>
...
codex --version</code></pre>
                ...
                <div class="mb-8">
                    ...
                    <div class="bg-[color:var(--cool-bg-alt)] rounded-lg p-6">
                        <p class="text-[var(--text-secondary)] mb-4"><strong>获取 CodeX 专用 API Token：</strong></p>
                        <ol class="list-decimal list-inside text-[var(--text-secondary)] mb-6 ml-4 space-y-2">
                            <li>访问 <a href="https://${apiHost}" target="_blank" class="text-[var(--accent-blue)] hover:underline">${apiName} 控制台</a></li>
                            <li>点击「添加令牌」</li>
                        ...
                        <p class="text-[var(--text-secondary)] mb-4"><strong>创建配置文件：</strong></p>
...
npm --version</code></pre>
                        ...
                        <p class="text-[var(--text-secondary)] mb-3"><strong>Ubuntu/Debian 系统：</strong></p>
                        <div class="bg-gray-900 rounded-lg overflow-hidden code-block mb-4">
                            <div class="flex items-center justify-between p-3 bg-gray-800">
                                <span class="text-gray-300 font-mono text-sm">Terminal</span>
                                <button onclick="copyCode(this)" class="copy-btn text-gray-400 hover:text-white transition-colors text-sm">复制</button>
...
npm --version</code></pre>
                        ...
                        <p class="text-[var(--text-secondary)] mb-3"><strong>CentOS/RHEL/Fedora 系统：</strong></p>
                        <div class="bg-gray-900 rounded-lg overflow-hidden code-block mb-4">
                            <div class="flex items-center justify-between p-3 bg-gray-800">
                                <span class="text-gray-300 font-mono text-sm">Terminal</span>
                                <button onclick="copyCode(this)" class="copy-btn text-gray-400 hover:text-white transition-colors text-sm">复制</button>
...
npm --version</code></pre>
                        ...
                        <p class="text-[var(--text-secondary)] mb-3"><strong>使用 NodeSource 仓库（推荐，获取最新版本）：</strong></p>
                        <div class="bg-gray-900 rounded-lg overflow-hidden code-block">
                            <div class="flex items-center justify-between p-3 bg-gray-800">
                                <span class="text-gray-300 font-mono text-sm">Terminal</span>
                                <button onclick="copyCode(this)" class="copy-btn text-gray-400 hover:text-white transition-colors text-sm">复制</button>
...
npm --version</code></pre>
                ...
                <div class="mb-8">
                    ...
                    <div class="bg-[color:var(--cool-bg-alt)] rounded-lg p-6">
                        <p class="text-[var(--text-secondary)] mb-4">在终端中执行以下命令：</p>
                        <div class="bg-gray-900 rounded-lg overflow-hidden code-block mb-4">
                            <div class="flex items-center justify-between p-3 bg-gray-800">
                                <span class="text-gray-300 font-mono text-sm">Terminal</span>
                                <button onclick="copyCode(this)" class="copy-btn text-gray-400 hover:text-white transition-colors text-sm">复制</button>
...
codex</code></pre>
            ...
            <div class="mt-16">
                <div class="max-w-4xl mx-auto">
                    <div class="bg-[color:var(--semi-color-bg-1)] rounded-2xl p-8 shadow-lg border border-[var(--card-border)]">
                        <div class="flex items-center mb-6">
                            <div class="w-12 h-12 bg-[var(--accent-blue)] rounded-xl flex items-center justify-center mr-4">
                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path>
                                </svg>
                            </div>
                            <div>
                                <h3 class="text-2xl font-bold text-[var(--text-primary)] mb-2">VSCode 配置教程</h3>
                                <p class="text-[var(--text-secondary)]">适用于所有平台的 Visual Studio Code 配置</p>
                            </div>
                        </div>
                        
                        <div class="mb-6">
                            <h4 class="text-lg font-semibold text-[color:var(--text-primary)] mb-3 flex items-center">
                                <svg class="w-5 h-5 mr-2 text-[var(--accent-blue)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                                配置步骤
                            </h4>
                            <div class="bg-blue-50 border-l-4 border-[var(--accent-blue)] p-4 mb-4">
                                <p class="text-blue-800 text-sm">
                                    <strong>注意：</strong>确保您已经安装了 ChatGPT/CodeX 相关的 VSCode 扩展插件
                                </p>
                            </div>
                            <p class="text-[var(--text-secondary)] mb-4">打开 VSCode 的 settings.json 文件，添加以下配置：</p>
                        </div>
                        ...
                        <div class="bg-gray-900 rounded-lg p-4 code-block mb-6 relative">
                            <div class="flex items-center justify-between mb-3">
                                ...
                                <button onclick="copyCode(this)" class="copy-btn bg-[var(--accent-blue)] hover:bg-[var(--accent-blue-hover)] text-white px-3 py-1 rounded text-xs transition-colors">
                                    复制配置
                                </button>
                            </div>
                            ...
                            <div class="grid md:grid-cols-3 gap-4">
                                <div class="bg-[color:var(--cool-bg-alt)] rounded-lg p-4">
                                    <div class="flex items-center mb-2">
                                        <svg class="w-4 h-4 mr-2 text-[var(--accent-blue)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        </svg>
                                        <span class="font-semibold text-[color:var(--text-primary)] text-sm">Windows</span>
                                    </div>
                                    <p class="text-[var(--text-secondary)] text-xs">Ctrl+Shift+P → "Preferences: Open Settings (JSON)"</p>
                                </div>
                                <div class="bg-[color:var(--cool-bg-alt)] rounded-lg p-4">
                                    <div class="flex items-center mb-2">
                                        <svg class="w-4 h-4 mr-2 text-[var(--accent-blue)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <p class="text-[var(--text-secondary)] text-xs">Cmd+Shift+P → "Preferences: Open Settings (JSON)"</p>
                                </div>
                                <div class="bg-[color:var(--cool-bg-alt)] rounded-lg p-4">
                                    <div class="flex items-center mb-2">
                                        <svg class="w-4 h-4 mr-2 text-[var(--accent-blue)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
