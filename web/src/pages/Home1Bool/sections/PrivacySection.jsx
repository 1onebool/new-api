...
<section id="privacy" class="py-24 bg-[color:var(--semi-color-primary-light-default)]">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-[var(--text-secondary)]">我们如何保护您的隐私和数据安全</p>
            ...
            <div class="mb-12">
                ...
                <div class="bg-[color:var(--semi-color-bg-1)] rounded-lg p-6 shadow-sm space-y-4">
                    <div>
                        <h4 class="font-semibold text-[var(--text-primary)] mb-2">我们收集的信息</h4>
            ...
            <div class="mb-12">
                ...
                <div class="grid md:grid-cols-3 gap-6">
                    <div class="bg-[color:var(--semi-color-bg-1)] rounded-lg p-6 shadow-sm">
                        ...
                        <h4 class="font-semibold text-[var(--text-primary)] mb-2">端到端加密</h4>
                    ...
                    <div class="bg-[color:var(--semi-color-bg-1)] rounded-lg p-6 shadow-sm">
                        ...
                        <h4 class="font-semibold text-[var(--text-primary)] mb-2">安全传输</h4>
                        <p class="text-[var(--text-secondary)] text-sm">您的 API 请求采用直连架构，不经过我们的中间服务器存储或缓存。</p>
                    </div>
                    <div class="bg-[color:var(--semi-color-bg-1)] rounded-lg p-6 shadow-sm">
                        ...
                        <h4 class="font-semibold text-[var(--text-primary)] mb-2">访问控制</h4>
                        <p class="text-[var(--text-secondary)] text-sm">严格的权限管理确保只有授权人员能够访问必要的系统数据。</p>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-[color:var(--semi-color-bg-1)] rounded-lg p-6 shadow-sm">
                    ...
                    <div class="grid md:grid-cols-3 gap-6">
                        <div class="text-center">
                            ...
                            <h4 class="font-semibold text-[var(--text-primary)] mb-2">直连 API</h4>
                            <p class="text-[var(--text-secondary)] text-sm">您的请求采用直连架构设计，不经过我们的服务器存储或缓存。</p>
                        </div>
                        <div class="text-center">
                            ...
                            <h4 class="font-semibold text-[var(--text-primary)] mb-2">无数据存储</h4>
                        ...
                        <div class="text-center">
                            ...
                            <h4 class="font-semibold text-[var(--text-primary)] mb-2">本地处理</h4>
                            <p class="text-[var(--text-secondary)] text-sm">代码分析和文件操作都在您的本地环境中进行，确保敏感信息不会离开您的设备。</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-12">
                ...
                <div class="bg-[color:var(--semi-color-bg-1)] rounded-lg p-6 shadow-sm">
                    <p class="text-[var(--text-secondary)] mb-3">我们如何使用收集的数据</p>
                    <ul class="text-[var(--text-secondary)] space-y-2 ml-6">
            ...
            <div class="mb-12">
                ...
                <div class="bg-[color:var(--semi-color-bg-1)] rounded-lg p-6 shadow-sm">
                    <p class="text-[var(--text-secondary)] mb-3">您对个人数据享有的权利</p>
                    <ul class="text-[var(--text-secondary)] space-y-2 ml-6">
                        <li>• 访问您的个人数据</li>
                        <li>• 更正不准确的数据</li>
                        <li>• 删除您的个人数据</li>
