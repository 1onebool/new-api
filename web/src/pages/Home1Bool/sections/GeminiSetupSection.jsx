const GeminiSetupSection = ({ config }) => {
  ...
  const html = `
<section id="gemini-setup" class="py-24 bg-[var(--cool-bg)]">
        <div class="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-24">
                <h2 class="text-5xl font-bold text-[var(--text-primary)] mb-8">Gemini CLI 安装步骤</h2>
                <p class="text-xl text-[var(--text-secondary)] max-w-3xl mx-auto">Google AI 编程助手安装指南</p>
            ...
            <div class="bg-[var(--cool-bg)] rounded-2xl p-8 mb-12 text-center">
                <h3 class="text-2xl font-bold text-[var(--text-primary)] mb-4">Gemini CLI 快速开始</h3>
                <p class="text-[var(--accent-blue-hover)] text-lg">Google AI 编程助手，Gemini 2.5 Pro 驱动</p>
            ...
            <div class="flex justify-center mb-12 sm:mb-16">
                <div class="bg-[color:var(--semi-color-bg-1)] rounded-xl p-2 sm:p-3 shadow-lg border border-[color:var(--card-border)] w-full max-w-md sm:max-w-none">
                    <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                        <button onclick="showGeminiSetupPlatform('windows')" id="gemini-setup-btn-windows" class="px-4 sm:px-8 py-3 sm:py-4 rounded-lg font-medium transition-colors text-sm sm:text-base bg-[var(--accent-blue)] text-white shadow-md">Windows</button>
                        <button onclick="showGeminiSetupPlatform('mac')" id="gemini-setup-btn-mac" class="px-4 sm:px-8 py-3 sm:py-4 rounded-lg font-medium transition-colors text-sm sm:text-base text-[var(--text-secondary)] hover:bg-[color:var(--cool-bg-alt)]">macOS</button>
                        <button onclick="showGeminiSetupPlatform('linux')" id="gemini-setup-btn-linux" class="px-4 sm:px-8 py-3 sm:py-4 rounded-lg font-medium transition-colors text-sm sm:text-base text-[var(--text-secondary)] hover:bg-[color:var(--cool-bg-alt)]">Linux</button>
                    </div>
                </div>
            </div>
...
npm --version</code></pre>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="bg-[var(--cool-bg)] rounded-lg p-6">
                            <p class="text-[var(--text-secondary)] mb-4">打开命令提示符或 PowerShell，执行以下命令：</p>
                            <div class="bg-gray-900 rounded-lg overflow-hidden code-block">
                                <div class="flex items-center justify-between p-3 bg-gray-800">
                                    <span class="text-gray-300 font-mono text-sm">CMD/PowerShell</span>
                                    <button onclick="copyCode(this)" class="copy-btn text-gray-400 hover:text-white transition-colors text-sm">复制</button>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="bg-[var(--cool-bg)] rounded-lg p-6">
                            ...
                            <p class="text-[var(--text-secondary)] mb-3">配置位置：<code class="bg-[color:var(--cool-bg-alt)] text-[color:var(--text-primary)] px-2 py-1 rounded text-sm">%USERPROFILE%\.gemini\</code></p>

                            <h5 class="text-md font-medium mb-3 mt-6">3.2 创建 .env 文件</h5>
                            <p class="text-[var(--text-secondary)] mb-3">在 .gemini 文件夹中创建 .env 文件：</p>
...
GEMINI_MODEL=gemini-3-pro-preview</code></pre>
                            ...
                            <p class="text-[var(--text-secondary)] mb-3">在 .gemini 文件夹中创建 settings.json 文件：</p>
                            <div class="bg-gray-900 rounded-lg overflow-hidden code-block">
                                <div class="flex items-center justify-between p-3 bg-gray-800">
  ...
  "security": {
    "auth": {
      "selectedType": "gemini-api-key"
                            ...
                            <div class="bg-[var(--cool-bg)] border-l-4 border-[var(--accent-blue)] p-4 rounded-r-lg mt-4">
                                <p class="text-[var(--accent-blue-hover)]"><strong>注意：</strong> 配置文件更加安全且便于管理，需要重启 Gemini CLI 才生效。</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="bg-[var(--cool-bg)] rounded-lg p-6">
                            <p class="text-[var(--text-secondary)] mb-4">配置完成后，运行以下命令启动：</p>
                            <div class="bg-gray-900 rounded-lg overflow-hidden code-block mb-4">
                                <div class="flex items-center justify-between p-3 bg-gray-800">
                                    <span class="text-gray-300 font-mono text-sm">CMD/PowerShell</span>
                                    <button onclick="copyCode(this)" class="copy-btn text-gray-400 hover:text-white transition-colors text-sm">复制</button>
                            ...
                            <div class="bg-[var(--cool-bg)] border-l-4 border-[var(--accent-blue)] p-4 rounded-r-lg">
                                <p class="text-[var(--accent-blue-hover)] mb-2"><strong>开始使用 Gemini CLI！</strong></p>
                                <ul class="text-[var(--accent-blue-hover)] space-y-1">
            ...
            <div id="gemini-setup-platform-mac" class="gemini-setup-platform-content hidden">
                <div class="bg-[color:var(--semi-color-bg-1)] rounded-2xl shadow-lg p-8 mb-8">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="bg-[var(--cool-bg)] rounded-lg p-6">
                            <p class="text-[var(--text-secondary)] mb-4">使用 Homebrew 安装：</p>
                            <div class="bg-gray-900 rounded-lg overflow-hidden code-block">
                                <div class="flex items-center justify-between p-3 bg-gray-800">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="bg-[var(--cool-bg)] rounded-lg p-6">
                            ...
                            <h5 class="text-md font-medium mb-3">3.1 创建 .gemini 文件夹</h5>
                            <p class="text-[var(--text-secondary)] mb-3">配置位置：<code class="bg-[color:var(--cool-bg-alt)] text-[color:var(--text-primary)] px-2 py-1 rounded text-sm">~/.gemini/</code></p>
            ...
            <div id="gemini-setup-platform-linux" class="gemini-setup-platform-content hidden">
                <div class="bg-[color:var(--semi-color-bg-1)] rounded-2xl shadow-lg p-8 mb-8">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="bg-[var(--cool-bg)] rounded-lg p-6">
                            <p class="text-[var(--text-secondary)] mb-4"><strong>Ubuntu/Debian:</strong></p>
                            <div class="bg-gray-900 rounded-lg overflow-hidden code-block">
                                <div class="flex items-center justify-between p-3 bg-gray-800">
                                    <span class="text-gray-300 font-mono text-sm">Terminal</span>
                                    <button onclick="copyCode(this)" class="copy-btn text-gray-400 hover:text-white transition-colors text-sm">复制</button>
